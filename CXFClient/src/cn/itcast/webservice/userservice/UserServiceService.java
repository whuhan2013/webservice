 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://userService.webservice.itcast.cn/", wsdlLocation = "http://10.129.69.114:7418/userService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://userService.webservice.itcast.cn/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.129.69.114:7418/userService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://userService.webservice.itcast.cn/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://userService.webservice.itcast.cn/", "UserServicePort"), UserService.class, features);
    }
